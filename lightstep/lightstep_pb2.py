...
_BINARYCARRIER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='deprecated_text_ctx', full_name='lightstep.BinaryCarrier.deprecated_text_ctx', index=0,
...
_BASICTRACERCARRIER_BAGGAGEITEMSENTRY._options = None
